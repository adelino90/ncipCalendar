...
const EditOfficeForm = ({refreshOffices})=> { 
    ...
    useEffect(() => {
     ...
     const loadValues = ()=>{
        ...
        const axiosrequest1 = axios.get('/getAllBureausOffices');
        const axiosrequest2 = axios.get('/getOffice/'+officeId);
    ...
    const submitOffice = (e)=>{
        ...
        var data = {
            ...
            if (validator.current.allValid()) {
                ...
                axios.post('/submitOfficeUpdate', data)
