...
const UpdateCalendar= ({ onAddEvent,obj }) => {
   
    const [text,setText] = useState(obj.text) ,
    [eventId] = useState(obj.id) ,
    [dayFrom,setDayFrom] = useState(obj.dayFrom),
    [dayTo,setDayTo] = useState(obj.dayTo),
    [collapse,setCollapse] = useState(false),
    [eventTypeId,setEventType] = useState(obj.eventTypeId),
    [eventTypes,setEventTypes] = useState([]),
    [eventZoomLink,setEventZoomLink] = useState(obj.eventZoomLink),
    [eventDetails,setEventEventDetails] = useState(obj.eventDetails),
    [eventNotificationSchedule,seteventNotificationSchedule] = useState(obj.eventNotificationSchedule);
  ...
  return (
    <form className = 'add-form' onSubmit={onSubmit}>
        ...
        <input type = 'submit' className='btn btn-success' value='Update Event' data-id={eventId}/>
        
        {/* Test Add Button */}
        {/* <br></br><br></br>

        <input type = 'filter' className='btn btn-primary' value='Filter Event'/> */}
    </form>
  )
}
