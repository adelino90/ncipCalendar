...
Route::post('/retrieveEvent', [App\Http\Controllers\EventController::class, 'retrieveEvent']);
...
Route::post('/filterEvents', [EventController::class, 'getFilterEventTypes']);

Route::get('/getEventType', [EventController::class, 'getEventType']);
